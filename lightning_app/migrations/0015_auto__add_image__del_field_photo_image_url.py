...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Image'
        db.create_table('lightning_app_image', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('photo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lightning_app.Photo'])),
            ('image_url', self.gf('django.db.models.fields.URLField')(max_length=200)),
        ))
        db.send_create_signal('lightning_app', ['Image'])

        # Deleting field 'Photo.image_url'
        db.delete_column('lightning_app_photo', 'image_url')


    def backwards(self, orm):
        # Deleting model 'Image'
        db.delete_table('lightning_app_image')

        # Adding field 'Photo.image_url'
        db.add_column('lightning_app_photo', 'image_url',
