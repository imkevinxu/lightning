...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Photo.rating'
        db.alter_column('lightning_app_photo', 'rating', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'Photo.rating'
        db.alter_column('lightning_app_photo', 'rating', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=1))
