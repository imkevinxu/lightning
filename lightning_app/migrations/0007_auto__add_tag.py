...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Tag'
        db.create_table('lightning_app_tag', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tagname', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lightning_app.UserProfile'])),
        ))
        db.send_create_signal('lightning_app', ['Tag'])


    def backwards(self, orm):
        # Deleting model 'Tag'
        db.delete_table('lightning_app_tag')
