...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Image.image_size'
        db.add_column('lightning_app_image', 'image_size',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Image.image_size'
        db.delete_column('lightning_app_image', 'image_size')
