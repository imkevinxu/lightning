...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('lightning_app_userprofile', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 7, 17, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.modified_at'
        db.add_column('lightning_app_userprofile', 'modified_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, default=datetime.datetime(2012, 7, 17, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.created_at'
        db.delete_column('lightning_app_userprofile', 'created_at')

        # Deleting field 'UserProfile.modified_at'
        db.delete_column('lightning_app_userprofile', 'modified_at')
