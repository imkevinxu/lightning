...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.fhp_username'
        db.add_column('lightning_app_userprofile', 'fhp_username',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.fhp_username'
        db.delete_column('lightning_app_userprofile', 'fhp_username')
