...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.twitter'
        db.alter_column('lightning_app_userprofile', 'twitter', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'UserProfile.facebookpage'
        db.alter_column('lightning_app_userprofile', 'facebookpage', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'UserProfile.flickr'
        db.alter_column('lightning_app_userprofile', 'flickr', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'UserProfile.facebook'
        db.alter_column('lightning_app_userprofile', 'facebook', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
        # Adding field 'Photo.is_chosen'
        db.add_column('lightning_app_photo', 'is_chosen',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'UserProfile.twitter'
        db.alter_column('lightning_app_userprofile', 'twitter', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'UserProfile.facebookpage'
        db.alter_column('lightning_app_userprofile', 'facebookpage', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'UserProfile.flickr'
        db.alter_column('lightning_app_userprofile', 'flickr', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'UserProfile.facebook'
        db.alter_column('lightning_app_userprofile', 'facebook', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
        # Deleting field 'Photo.is_chosen'
        db.delete_column('lightning_app_photo', 'is_chosen')
    ...
    models = {
        ...
        'lightning_app.image': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image_size': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True'}),
            'image_url': ('django.db.models.fields.URLField', [], {'max_length': '200'}),
            'photo': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lightning_app.Photo']"})
        },
        'lightning_app.photo': {
        ...
        'lightning_app.userprofile': {
            ...
            'facebookpage': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            'fhp_username': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'firstname': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'flickr': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
